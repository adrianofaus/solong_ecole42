...
/*   Updated: 2021/12/14 18:33:23 by afaustin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	{
		game.mlx = mlx_init();
		game.win = mlx_new_window(game.mlx, IMG_SIZE * game.x_axis, IMG_SIZE * game.y_axis, "so_long");	
		mlx_hook(game.win, 3, 1L<<1, input, &game);
