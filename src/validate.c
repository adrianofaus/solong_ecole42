...
/*   Updated: 2021/12/16 21:08:09 by afaustin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (game->verify.py == 0 || game->verify.py == (game->y_axis - 1)
		|| game->verify.px == 0 || game->verify.px == (game->x_axis - 1))
		return (1);
	return (0);
}
